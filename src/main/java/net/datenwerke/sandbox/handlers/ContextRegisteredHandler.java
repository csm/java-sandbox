...
/**
 * Handler that is informed on the registration of a sandbox context.
 * 
...
public interface ContextRegisteredHandler extends SandboxHandler {
	...
	/**
	 * Called by the {@link SandboxService} if a context is registered.
	 * 
	 * @param key
	 * @param context
	 */
	public void contextRegistered(String key, SandboxContext context);
